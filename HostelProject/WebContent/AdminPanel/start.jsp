...
#inputForm option,select:hover{
	cursor: pointer;
	border: 2px groove #FF3;
}
#inputForm input,select,option{
...
<script type="text/javascript">
	function validateForm(){
		var month=document.dateForm.month.value;
		if(month=="" || month==null){
			alert("Month must be selected !!");
			return false;
		   }
		var year = document.dateForm.year.value;
	    if(year=="" || year==null)
	     {
      ...
      <nav>
        <div id="menu_container">
          <ul class="sf-menu" id="nav">
            ...
            <li id="selected"><a href="#">Mess Bills</a>
            	<ul>
            ...
            <li><a href="#">Groceries</a>
            	<ul>
                	<li><a href="#">Add New Grocery</a></li>
...
<div align="center"><h2 id="text">Please Enter From and To Dates for Mess Bill Calculation</h2></div>
<br /><br />
<div id="center" align="center">
<form name="dateForm" action="confirmdates.jsp" method="post" id="inputForm">
Please Select Month:&nbsp;
<select name="month" autofocus="autofocus" required>
...
<br /><br />
From:&nbsp; <input type="date" name="from" required="required" placeholder="Enter Date" autocomplete="off" pattern="(0[1-9]|[12][0-9]|3[01])\-(0[1-9]|1[0-2])\-\d{4}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
To:&nbsp; <input type="date" name="to" required="required" placeholder="Enter Date" autocomplete="off" pattern="(0[1-9]|[12][0-9]|3[01])\-(0[1-9]|1[0-2])\-\d{4}" />&nbsp;&nbsp;&nbsp;&nbsp;<span id="example">Ex: 04-02-1995</span><br />
<input type="hidden" name="hidden" value="Mandava" />
<br />
<button name="submit" type="submit" onclick="return validateForm()">Next</button>
</form>
</div>
</div>
    </div>
